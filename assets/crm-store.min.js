  ...
  try {
    ...
    if (migrateJobs && result.jobs.length && typeof wsMergeJobs === "function") {
      ...
      if (wsMergeJobs(result.jobs)) {
        result.jobs = [];
        try { localStorage.setItem(CRM_KEY, JSON.stringify(result)); } catch (e) {   }

...
var LM_FEATURES = [
  ...
  { id: "jobs", level: LM_LEVEL.PRO, route: "jobs", key: "feat_projects_redirect",
    module: false, note: "Retired route kept only as a permanent redirect to projects." },
  ...
  { id: "crm", level: LM_LEVEL.PRO, route: null, key: "feat_crm", session: 26,
    note: "Chapter XXIV is a path through the modules — klient → projekt → wycena → " +
      "historia — not a page of its own, so it has no route." },
];
